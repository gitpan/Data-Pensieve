# This Makefile is for the Data::Pensieve extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Data/Pensieve.pm]
#     AUTHOR => [q[Michael Aquilina <aquilina@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Data::Pensieve]
#     PREREQ_PM => { DateTime=>q[0], DateTime::Format::MySQL=>q[0], Storable=>q[0], Carp=>q[0], List::Util=>q[0], Text::Diff=>q[0], List::MoreUtils=>q[0], DBI=>q[0], Moose=>q[0] }
#     VERSION_FROM => q[lib/Data/Pensieve.pm]
...
MAKE = make
FULLEXT = Data/Pensieve
BASEEXT = Pensieve
PARENT_NAME = Data
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Data/Pensieve.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Data/Pensieve.pm \
	lib/Data/Pensieve/Revision.pm

PM_TO_BLIB = lib/Data/Pensieve.pm \
	blib/lib/Data/Pensieve.pm \
	lib/Data/Pensieve/Revision.pm \
	blib/lib/Data/Pensieve/Revision.pm
...
DISTNAME = Data-Pensieve
DISTVNAME = Data-Pensieve-0.03
...
manifypods : pure_all  \
	lib/Data/Pensieve.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Data/Pensieve.pm $(INST_MAN3DIR)/Data::Pensieve.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Simple tool for interacting with revisioned data'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Michael Aquilina <aquilina@cpan.org>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Data-Pensieve' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  DateTime::Format::MySQL: 0' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Simple tool for interacting with revisioned data",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Michael Aquilina <aquilina@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Data-Pensieve",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "DateTime::Format::MySQL" : 0,' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Simple tool for interacting with revisioned data</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Michael Aquilina &lt;aquilina@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Text::Diff" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Data/Pensieve.pm blib/lib/Data/Pensieve.pm \
	  lib/Data/Pensieve/Revision.pm blib/lib/Data/Pensieve/Revision.pm 
